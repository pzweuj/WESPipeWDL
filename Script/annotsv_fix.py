...
# 输出内容标题
outputHeaderList = ["#Chrom", "Start", "End", "Length","Type", "CN", "ISCN", "CytoBand", "Gene", "GeneCount",
...
for line in input:
    if line.startswith("AnnotSV_"):
        ...
        outputStringList = [lineDict["SV_chrom"], lineDict["SV_start"], lineDict["SV_end"], lineDict["SV_length"], lineDict["SV_type"], lineDict["user#1"], lineDict["ISCN"], lineDict["CytoBand"], lineDict["Gene_name"], lineDict["Gene_count"],
